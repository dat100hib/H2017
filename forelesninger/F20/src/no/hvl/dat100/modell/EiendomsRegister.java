...
public class EiendomsRegister {
	...
	// gns og bns blir brukt som n�kkel (key) i HashMap
	...
	/**
	 * Registrer (legg til) eier p� en eiendom.
	 * @param eier eier som skal registreres p� eiendom
	 * @param gns g�rdsnummer for eiendom
